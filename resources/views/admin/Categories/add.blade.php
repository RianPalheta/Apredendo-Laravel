...
@section('js')
    <script>
        ...
        const url_list = "{{ route('categories.list') }}";
        const url_add = "{{ route('categories.add') }}";
    </script>
    <script src="{{ asset('assets/js/plugins/jquery.min.js') }}"></script>
    <script src="{{ asset('assets/js/plugins/toastr.min.js') }}"></script>
    <script src="{{ asset('assets/js/categories/painel.categories.add.js') }}"></script>
@endsection

@section('content')
    <div class="card">
        <div class="card-body">
            <form id="categorie-add">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" name="name" class="form-control" id="name" placeholder="Digite o nome da categoria">
                    </div>
                </div>
                ...
                <div class="d-flex">
                    <div class="d-flex justify-content-center align-items-center" style="flex:1;">
                        ...
                        <div class="d-flex new_img_view justify-content-center align-items-center m-2" style="width:100px">
                            <img id="img-categorie" width="100%" src="{{ asset('media/categories/default.png') }}">
                        </div>
                    </div>
                </div>
